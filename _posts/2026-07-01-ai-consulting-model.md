...
thumbnail-img: /assets/img/ai-consulting.png
---

*I work as a principal architect at a management and technology consultancy. These are my own observations and opinions, not my employer's, but they've changed how I approach working with our clients.*
...
AI has made that model untenable, not because consultants are suddenly less capable, but because the asymmetry has collapsed. The field is moving faster than anyone can track. There is no stable body of knowledge to stay ahead of. The best practices from six months ago are already candidates for reconsideration.

<figure class="post-figure">
  <img src="/assets/img/ai-consulting.png" alt="A senior engineer gestures across a bridge toward a junior developer, with AI-generated code on one side and architectural diagrams on the other" />
  <figcaption class="fig-caption">When the field moves this fast, what a consultant brings isn't certainty — it's pattern recognition across clients and industries.</figcaption>
</figure>
...
## What Consulting Actually Offers Now

Despite all of that, the cross-client vantage point is real, and it matters more when the environment is moving fast.
...
The client working alone is running one experiment. The consultant's value isn't superior knowledge; it's superior sample size. In a domain where everyone is learning in real time, sample size compounds fast.
...
That's a different profile than traditional consulting has often selected for. It favors people comfortable with incomplete information, who can distinguish between "we don't know yet" and "we don't know and it matters," and who can translate an early signal from one client into a useful question for another.
...
Couple that with deep industry and domain knowledge and it becomes something harder to replicate. A consultant who has seen the same AI pattern fail across three clients *and* understands the regulatory constraints of a specific industry, or the operational realities of a particular business model, can offer guidance that neither a generalist nor an internal hire can easily match.
...
The firms and practitioners that figure this out earn something durable: credibility built on honesty, not borrowed from an authority that no longer holds. The ones that don't will keep losing ground to clients who can see the confidence isn't warranted.

The knowledge-asymmetry advantage is gone. The cross-client synthesis advantage is real. They're different things, and the industry would do well to say so plainly.

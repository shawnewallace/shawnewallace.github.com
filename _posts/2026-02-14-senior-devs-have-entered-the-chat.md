---
layout: post
subtitle: "When senior engineers stopped rolling their eyes and started shipping with AI"
title: "Senior Devs Have Entered the Chat"
...
<figure class="post-figure">
  <img src="/assets/img/senior-devs-entered-the-chat.png" alt="Senior Devs Have Entered the Chat" />
  <figcaption class="fig-caption">When senior engineers stopped rolling their eyes and started shipping with AI</figcaption>
</figure>
...
A [Fastly survey](https://www.fastly.com/blog/senior-developers-ship-more-ai-code) of nearly 800 developers found that about a third of senior engineers — those with 10+ years of experience — now say more than half their shipped code is AI-generated. That's 2.5 times the rate reported by junior developers. The people with the most experience are leaning in the hardest.
...
[Builder.io](https://www.builder.io/blog/ai-software-engineer) put it well: "The '10x Engineer' used to be a myth about a lone genius. In 2026, it's just an engineer who learned to manage ten agents."

## The Nuance Nobody Wants to Hear

It's not all upside. A rigorous [study by METR](https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/) found that experienced open-source developers were actually 19% slower when using AI tools on mature codebases — even though they believed they were 20% faster. The tools can create a false sense of velocity while introducing review overhead and subtle bugs.
